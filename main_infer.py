...
# learning
flags.DEFINE_float('lr',  default=0.003, help='initial learning rate [default: 0.001]')
...
# option
flags.DEFINE_string('snapshot',  default='snapshot/2020-07-31_08-21-26/best_TREC_adv_sym_0.0_0.0005_2.5_steps_3300.pt', help='filename of model snapshot [default: None] ex)snapshot/2020-07-07_09-14-42/best_steps_22100.pt')
...
flags.DEFINE_float('patience',  default=0.5, help='the probability for dropout [default: 0.5]')
