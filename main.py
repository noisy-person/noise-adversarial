...
flags.DEFINE_integer('epochs',  default=60, help='number of epochs for train [default: 256]')
...
# option
flags.DEFINE_string('snapshot',  default='snapshot/2020-07-21_03-51-53/best_steps_2700.pt', help='filename of model snapshot [default: None] ex)snapshot/2020-07-07_09-14-42/best_steps_22100.pt')
#flags.DEFINE_string('snapshot',  default='snapshot/2020-07-21_01-41-53/best_steps_1300.pt', help='filename of model snapshot [default: None] ex)snapshot/2020-07-07_09-14-42/best_steps_22100.pt')
...
flags.DEFINE_float('noise_rate',  default=0.8, help='the probability for dropout [default: 0.5]')
