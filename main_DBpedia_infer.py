...
# optionasd
flags.DEFINE_string('snapshot',  default='snapshot/2020-08-19_05-10-18/best_DBpedia_adv_uni_0.5_0.02_0.1_steps_36100.pt', help='filename of model snapshot [default: None] ex)snapshot/2020-07-07_09-14-42/best_steps_22100.pt')
...
flags.DEFINE_integer('GPU',  default=0, help='how many steps to wait before testing [default: 100]')
